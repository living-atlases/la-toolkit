...
# From: https://github.com/ansible/ansible/blob/stable-2.9/lib/ansible/plugins/callback/log_plays.py
...
class CallbackModule(CallbackBase):
    ...
    def set_options(self, task_keys=None, var_options=None, direct=None):
        ...
        self.path = os.path.join(self.log_folder, self.log_file)
    ...
    def v2_playbook_on_stats(self, stats):
        ...
        self.log(json.dumps(output, cls=AnsibleJSONEncoder, indent=4, sort_keys=True))
