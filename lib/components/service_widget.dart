...
class ServiceWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final TextStyle domainTextStyle = TextStyle(
      fontSize: 16,
    ...
    return StoreConnector<AppState, _LAServiceViewModel>(
      ...
      builder: (BuildContext context, _LAServiceViewModel vm) {
        ...
        final ValueNotifier<bool> domainSwitchController = ValueNotifier<bool>(
          false,
        );
                              ...
                              Column(
                                ...
                                children: <Widget>[
                                  Row(
                                    children: <Widget>[
                                      Text(
                                        'Use the ${serviceDesc.name} service?${serviceName == dockerSwarm ? ' (deprecated)' : ''}',
                                        style: TextStyle(
                                          decoration: serviceName == dockerSwarm
                            ...
                            if (serviceDesc.repository != null)
                              Tooltip(
                                ...
                                child: IconButton(
                                  onPressed: () async {
                                    await launchUrl(
                                      Uri.parse(serviceDesc.repository!),
                                    );
                                  },
    ...
    return IntrinsicWidth(
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ConstrainedBox(
              constraints: BoxConstraints(minWidth: isSub ? 80.0 : 100),
              child: child,
            ),
          ],
        ),
  ...
  Widget _createSubUrlField(
    LAService service,
    LAServiceDesc serviceDesc,
    _LAServiceViewModel vm,
    String error,
  ) {
    return _wrapField(
