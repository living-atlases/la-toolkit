...
class TipsCard extends StatelessWidget {
  const TipsCard({super.key, required this.text, this.margin = const EdgeInsets.fromLTRB(0, 30, 0, 0)});
  ...
  Widget build(BuildContext context) {
    return Card(
        ...
        child: Row(
            ...
            children: <Widget>[
              const Padding(padding: EdgeInsets.fromLTRB(20, 20, 0, 20), child: Icon(Icons.info, color: Colors.grey)),
              Expanded(
                  child: Markdown(
                      shrinkWrap: true,
