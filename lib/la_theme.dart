...
class LAColorTheme {
  ...
  static MaterialColor laPalette = const MaterialColor(0xFF78B578, <int, Color>{
    50: Color(0xFFEFF6EF),
  ...
  static MaterialColor laPaletteAccent =
      const MaterialColor(0xFFB6FFB6, <int, Color>{
  ...
  static final TextStyle unDeployedTextStyle = TextStyle(
    color: unDeployedColor,
  );
