...
HostServiceCheck _$HostServiceCheckFromJson(Map<String, dynamic> json) => HostServiceCheck(
      id: json['id'] as String?,
      name: json['name'] as String,
      type: $enumDecode(_$ServiceCheckTypeEnumMap, json['type']),
      host: json['host'] as String? ?? 'localhost',
      serviceDeploys: HostServiceCheck._fromJson(json['serviceDeploys'] as List?),
      services: HostServiceCheck._fromJson(json['services'] as List?),
      args: json['args'] as String? ?? '',
    );

Map<String, dynamic> _$HostServiceCheckToJson(HostServiceCheck instance) => <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
