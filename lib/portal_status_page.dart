    ...
    return StoreConnector<AppState, _PortalStatusViewModel>(
      ...
      converter: (Store<AppState> store) {
        return _PortalStatusViewModel(
          ...
          serverServicesToMonitor: store.state.currentProject
      ...
      builder: (BuildContext context, _PortalStatusViewModel vm) {
        ...
        for (final String serverId in vm.checkResults.keys) {
          ...
          final LAServer s = vm.project.servers.firstWhere(
          ...
          child: Scaffold(
            ...
            bottomNavigationBar: ConvexAppBar(
              ...
              items: <TabItem<dynamic>>[
                TabItem<dynamic>(icon: MdiIcons.server, title: 'Servers'),
                              ...
                              children: <Widget>[
                                ...
                                for (final MapEntry<
                                  ...
                                  ServiceCheckProgressIndicator(
                                    serverName:
                                        entry.value['serverName'] as String,
                                    status: entry.value['status'] as String,
                                    resultsCount:
                                        entry.value['resultsCount'] as int,
                                  ),
