  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, _ProjectsPageViewModel>(
      ...
      builder: (BuildContext context, _ProjectsPageViewModel vm) {
        final List<LAProject> pjs = vm.state.projects
          ...
          FractionalTranslation(
            ...
            child: Align(
              ...
              child: CircleAvatar(
                radius: 25.0,
                child:
                    project.getVariableValue('favicon_url') != null &&
                        !AppUtils.isDemo()
                    ? ImageIcon(
                        NetworkImage(
                          AppUtils.proxyImg(
                            project.getVariableValue('favicon_url')! as String,
                          ),
                        ),
