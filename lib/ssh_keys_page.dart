...
import 'components/text_with_help.dart';
  ...
  Widget build(BuildContext context) {
    return DataTable(
      ...
      columns: const <DataColumn>[
        DataColumn(label: Text('NAME'), tooltip: 'This is the key name'),
        DataColumn(label: Text('DESCRIPTION'), tooltip: ''),
        DataColumn(
                  ...
                  Padding(
                    ...
                    child: Tooltip(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () async {
                          await FlutterClipboard.copy(sshKey.publicKey);
                          if (context.mounted) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text('SSH Key copied to clipboard'),
                              ),
                            );
                          }
                        },
